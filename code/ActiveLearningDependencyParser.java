...
public class ActiveLearningDependencyParser {
    ...
    private static List<DependencyTree> runDependencyParserEpoch(int epochNum, int numWords,
            Properties prop, String trainPath, String unlabelledPath, String testPath, String modelPath, 
        ...
        List<DependencyTree> predictedParses = model.testCoNLLProb(unlabelledPath);
    ...
    public static void main(String[] args) {
        ...
        String labelledPath = Paths.get(tmpDirPath, "labelled.conllx").toString();
        // unannotated trees file path (used for testing by the active learner)
        String unlabelledPath = Paths.get(tmpDirPath, "unlabelled.conllx").toString();
        ...
        for (int i = 0; i < maxALEpochs; ++i) {
                ...
                List<DependencyTree> predictedParses = runDependencyParserEpoch(i, numTrainingWords,
                        prop, labelledPath, unlabelledPath, testPath, modelPath, embeddingPath, stats);
